(function () {
  ...
  function renderDetail(bar) {
    ...
    html += '<div class="info-card-content"><span class="info-card-label">LOCATION</span><span class="info-card-value">' + escapeHtml(bar.address) + '</span><a class="info-card-sub directions-link" href="https://www.google.com/maps/dir/?api=1&destination=' + encodeURIComponent(bar.address) + '" target="_blank" rel="noopener noreferrer">GET DIRECTIONS &rarr;</a></div></div>';
